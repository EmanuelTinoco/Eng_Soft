...
namespace EG.Controllers
{
    public class SugestaosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "descricao")] Sugestao sugestao)
        {
            sugestao.id_user = int.Parse(IdentidadeUser.GetId());
            ...
            ViewBag.id_user = new SelectList(db.Utilizador, "id", "id_user", sugestao.id_user);
            return View(sugestao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_user,data,descricao")] Sugestao sugestao)
        {
            if (ModelState.IsValid)
            {
