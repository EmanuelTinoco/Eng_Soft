...
namespace EG.Controllers
{
    public class Reportar_ProblemaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,status,descricao,localizacao,fotos")] Reportar_Problema reportar_Problema)
        {
            ...
            ViewBag.id = new SelectList(db.Utilizador, "id", "cod_postal", reportar_Problema.id);
            ViewBag.id = new SelectList(db.Utilizador, "id", "cod_postal", reportar_Problema.id);
            return View(reportar_Problema);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,status,descricao,localizacao,fotos")] Reportar_Problema reportar_Problema)
        {
            if (ModelState.IsValid)
            {
