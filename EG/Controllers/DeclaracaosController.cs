...
namespace EG.Controllers
{
    public class DeclaracaosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,ficheiro,data,descricao")] Declaracao declaracao)
        {
            ...
            ViewBag.id = new SelectList(db.Utilizador, "id", "cod_postal", declaracao.id);
            return View(declaracao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,ficheiro,data,descricao")] Declaracao declaracao)
        {
            if (ModelState.IsValid)
            {
